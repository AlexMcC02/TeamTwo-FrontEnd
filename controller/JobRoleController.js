...
var jobRoleService = require('../service/JobRoleService');
module.exports = function (app) {
    var _this = this;
    app.get('/job_roles', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var data, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, jobRoleService.getJobRoles()];
                case 2:
                    data = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
